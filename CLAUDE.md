...
The 2026-04-29 lessons-learned addenda recorded in the consuming project's `CLAUDE.md` apply to any code path of this submodule that participates in a project feature:
